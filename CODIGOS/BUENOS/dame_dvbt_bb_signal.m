...
% ALEJANDRO
% Changed function output

function [y,Tu,cont_pilot_carriers,data] = dame_dvbt_bb_signal(BW, tx_mode, frame_offset, guard, mod_type, alpha, T)
